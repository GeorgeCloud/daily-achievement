        ...
        <div class="px-1 md:w-3/5 h-full">
          <div class="flex items-center min-w-full justify-center flex-col">
            ...
            <div class="h-fit text-2xl md:text-3xl font-semibold md:w-2/3 md:w-screen pt-16 flex flex-col items-center">
              ...
              <div id="parent-bg" class="rounded-2xl  w-fit md:w-2/3 bg-slate-200/50 mt-20 md:mt-8 text-neutral-600 shadow-lg shadow-slate-300/90">
                <button id="child-bg-1" class="rounded-2xl text-base md:text-lg font-normal md:font-light py-3 md:py-5 w-fit px-7 md:px-5 md:w-1/2 hover:font-bold tracking-widest">Register</button>
                <button id="child-bg-2" class="rounded-2xl text-base md:text-lg bg-white font-normal md:font-light h-full px-7 md:px-5 py-3 md:py-5 w-fit md:w-1/2 hover:font-bold tracking-wider">Sign In</button>
              </div>
            </div>
            {/* Register  */}
            <form class="w-full py-20 md:py-10 flex flex-col items-center justify-center">
              <h2 class="text-2xl md:text-3xl font-semibold text-neutral-700 md:pt-10 pb-7 ">Hello Again!</h2>
              <p class="text-center text-sm md:text-lg font-extralight md:w-1/3">Welcome back you've</p>
              <p class="text-center text-sm md:text-lg font-extralight md:w-1/3">been missed!</p>
